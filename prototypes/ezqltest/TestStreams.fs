...
let test_streamsGroupby (test:Test) =
    ...
    test.AssertThat (In "someRecordPerRoom"
                      [SetKey "1" "{ :a = 5, :b = 25, :c = 90 }" (At  2)
                       SetKey "1" "{ :a = 5, :b = 25, :c = 71 }" (At  3)
                       SetKey "1" "{ :a = 5, :b = 25, :c = 81 }" (At  4)
                       SetKey "3" "{ :a = 5, :b = 45, :c = 81 }" (At  4)
                       SetKey "1" "{ :a = 5, :b = 25, :c = 91 }" (At  5)
                       SetKey "3" "{ :a = 5, :b = 45, :c = 91 }" (At  5)
                       SetKey "1" "{ :a = 5, :b = 25, :c = 72 }" (At  6)
                       SetKey "3" "{ :a = 5, :b = 45, :c = 72 }" (At  6)
                       SetKey "2" "{ :a = 5, :b = 50, :c = 72 }" (At  6)
                       SetKey "1" "{ :a = 5, :b = 25, :c = 82 }" (At  7)
                       SetKey "2" "{ :a = 5, :b = 50, :c = 82 }" (At  7)
                       SetKey "3" "{ :a = 5, :b = 30, :c = 82 }" (At  7)
                       SetKey "1" "{ :a = 5, :b = 25, :c = 92 }" (At  8)
                       SetKey "2" "{ :a = 5, :b = 50, :c = 92 }" (At  8)
                       SetKey "3" "{ :a = 5, :b = 30, :c = 92 }" (At  8)
                       SetKey "1" "{ :a = 5, :b = 23, :c = 92 }" (At  9)])