...
let test_entitiesMisc3 (test:Test) =
  test.AssertThat (In "productIdsPerRoom"
                    [SetKeyRaw "1" (VDict (ref Map.empty))                                      (At 2)
                     SetKeyRaw "1" (VDict (ref (Map.of_list [VInt 1, VInt 1])))                 (At 3)     // Room 1 is created
                     SetKeyRaw "3" (VDict (ref Map.empty))                                      (At 4)     // Room 3 is created
                     SetKeyRaw "1" (VDict (ref (Map.of_list [VInt 1, VInt 1; VInt 2, VInt 2]))) (At 4)     // Room 1 now contains product 2
                     SetKeyRaw "1" (VDict (ref (Map.of_list [VInt 1, VInt 1])))                 (At 6)     // Product 2 leaves room 1
                     SetKeyRaw "2" (VDict (ref (Map.of_list [VInt 2, VInt 2])))                 (At 6)     // Product 2 enters room 2
                     SetKeyRaw "1" (VDict (ref (Map.of_list [VInt 1, VInt 1; VInt 3, VInt 3]))) (At 7)     // Product 3 enters room 1
                     SetKeyRaw "1" (VDict (ref (Map.of_list [VInt 3, VInt 3])))                 (At 8)     // Product 1 leaves room 1
                     SetKeyRaw "2" (VDict (ref (Map.of_list [VInt 1, VInt 1; VInt 2, VInt 2]))) (At 8)     // Product 1 enters room 2
                     SetKeyRaw "2" (VDict (ref (Map.of_list [VInt 1, VInt 1])))                 (At 9)     // Product 2 leaves room 2
                     SetKeyRaw "3" (VDict (ref (Map.of_list [VInt 2, VInt 2])))                 (At 9)])  
